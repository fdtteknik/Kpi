...
#
def _kpi1(_cursor):
    _targets = [('Dec-17', 3911760), ('Nov-17', 2960593), ('Oct-17', 3501450), ('Sep-17', 3450718), ('Aug-17', 2716248), ('Jul-17', 2071735), ('Jun-17', 3541161), ('May-17', 3133696), ('Apr-17', 2779404), ('Mar-17', 2973141), ('Feb-17', 2031047), ('Jan-17', 1945652), ('Dec-17', 2263152), ('Nov-16', 1905652)]
    grand_result = []
    today = datetime.datetime.today()
    current_month = datetime.datetime(today.year, today.month, 1)
    for i in range(0, 12):
...
#
def _kpi2(_cursor):
    _targets = [('Dec-17', 160000), ('Nov-17', 160000), ('Oct-17', 160000), ('Sep-17', 160000), ('Aug-17', 120000), ('Jul-17', 40000), ('Jun-17', 120000), ('May-17', 160000), ('Apr-17', 160000), ('Mar-17', 160000), ('Feb-17', 160000), ('Jan-17', 120000), ('Dec-17', 120000), ('Nov-16', 160000)]
    grand_result = []
    today = datetime.datetime.today()
    current_month = datetime.datetime(today.year, today.month, 1)
    for i in range(0, 12):
...
#
def _kpi4(_cursor):
    _targets = [('Dec-17', 200000), ('Nov-17', 300000), ('Oct-17', 300000), ('Sep-17', 300000), ('Aug-17', 112500), ('Jul-17', 0), ('Jun-17', 112500), ('May-17', 300000), ('Apr-17', 300000), ('Mar-17', 300000), ('Feb-17', 300000), ('Jan-17', 300000), ('Dec-17', 112500), ('Nov-16', 300000)]
    grand_result = []
    today = datetime.datetime.today()
    current_month = datetime.datetime(today.year, today.month, 1)
    for i in range(0, 12):
...
#
def _kpi5(_cursor):
    _targets = [('Dec-17', 240000), ('Nov-17', 360000), ('Oct-17', 360000), ('Sep-17', 360000), ('Aug-17', 240000), ('Jul-17', 120000), ('Jun-17', 240000), ('May-17', 360000), ('Apr-17', 360000), ('Mar-17', 360000), ('Feb-17', 360000), ('Jan-17', 360000), ('Dec-17', 240000), ('Nov-16', 360000)]
    grand_result = []
    today = datetime.datetime.today()
    current_month = datetime.datetime(today.year, today.month, 1)
    for i in range(0, 12):
...
#
def _kpi6(_cursor):
    _targets = [('Dec-17', 30000), ('Nov-17', 40000), ('Oct-17', 40000), ('Sep-17', 40000), ('Aug-17', 30000), ('Jul-17', 10000), ('Jun-17', 30000), ('May-17', 40000), ('Apr-17', 40000), ('Mar-17', 40000), ('Feb-17', 40000), ('Jan-17', 40000), ('Dec-17', 30000), ('Nov-16', 40000)]
    grand_result = []
    today = datetime.datetime.today()
    current_month = datetime.datetime(today.year, today.month, 1)
    for i in range(0, 12):
